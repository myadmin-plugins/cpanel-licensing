...
class Plugin {
	...
	public static function Settings(GenericEvent $event) {
		...
		$settings->add_text_setting('apisettings', 'cpanel_username', 'Cpanel Username:', 'Cpanel Username', $settings->get_setting('FANTASTICO_USERNAME'));
		$settings->add_text_setting('apisettings', 'cpanel_password', 'Cpanel Password:', 'Cpanel Password', $settings->get_setting('FANTASTICO_PASSWORD'));
		$settings->add_dropdown_setting('stock', 'outofstock_licenses_cpanel', 'Out Of Stock Cpanel Licenses', 'Enable/Disable Sales Of This Type', $settings->get_setting('OUTOFSTOCK_LICENSES_FANTASTICO'), array('0', '1'), array('No', 'Yes', ));
	}
